...
### Core Experience
- **🗺️ Live Interactive Map**: A core feature using the Google Maps API. It features a custom dark style, real-time route drawing, and smooth vehicle animation to track your ride's progress.
...
- **🚗 Real-Time Ride Tracking**: The live map shows your driver's arrival and trip progress with a real-time ETA countdown and an animated vehicle.
